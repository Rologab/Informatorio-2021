...
public class Empleado {
    ...
    public static Map<String, Empleado> obtenerEmpleadoMasJovenViejo(List<Empleado> empleados) {
        ...
        employeesMap.put("más Joven", empleados.get(0));
        employeesMap.put("más Mayor", empleados.get(empleados.size() - 1));
        return employeesMap;
    }
    public static Map<String, Empleado> obtenerSalariosEmpleados(List<Empleado> empleados) {
        ...
        employeesMap.put("Salario más bajo", empleados.get(0));
        employeesMap.put("Salario más alto", empleados.get(empleados.size() - 1));
        return employeesMap;
    }
